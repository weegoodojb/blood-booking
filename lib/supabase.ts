...
export type EventInfo = { id:string; title:string; event_date:string; location:string; active:boolean; questionnaire_url?:string|null; privacy_purpose:string; privacy_retention:string; privacy_disposal:string };
